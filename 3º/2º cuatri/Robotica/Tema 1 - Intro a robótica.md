...
### 4. EJEMPLOS DE ROBOTS EN LA ACTUALIDAD

El documento presenta diversos tipos de robots actuales:
...
### 5. HISTORIA Y EVOLUCIÓN DE LA ROBÓTICA
...
Significado: La protección humana es absoluta y no negociable
...
Significado: Los robots deben ser útiles pero sometidos a restricciones de seguridad
...
Significado: Los robots pueden actuar en su defensa pero nunca contra humanos

**Jerarquía de Leyes:** Primera > Segunda > Tercera (conflictos se resuelven por orden de prioridad)

---

### 7. APLICACIONES INDUSTRIALES DE LA ROBÓTICA
...
### 8. APLICACIONES DE LA ROBÓTICA EN INVESTIGACIÓN
